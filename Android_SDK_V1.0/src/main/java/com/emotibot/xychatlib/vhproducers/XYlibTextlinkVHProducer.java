...
import com.emotibot.xychatlib.viewholders.XYlibTextlinkVH;

/**
 * Created by ldy on 2017/3/6.
 */

public class XYlibTextlinkVHProducer implements XYlibBaseProducer {
    public XYlibBaseViewHolder createViewHolder(LayoutInflater inflater, ViewGroup parent,
        ...
        return new XYlibTextlinkVH(view);
    }
}
