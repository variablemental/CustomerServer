...
class ViewPropertyAnimatorPreHC extends com.emotibot.xychatlib.nineoldandroids.view.ViewPropertyAnimator {
    /**
    ...
    @Override
    public com.emotibot.xychatlib.nineoldandroids.view.ViewPropertyAnimator setInterpolator(/*Time*/Interpolator interpolator) {
    ...
    @Override
    public com.emotibot.xychatlib.nineoldandroids.view.ViewPropertyAnimator setListener(Animator.AnimatorListener listener) {
        mListener = listener;
        return this;
    }
