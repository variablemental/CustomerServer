...
import com.emotibot.xychatlib.nineoldandroids.animation.IntEvaluator;
 ...
 */
public class ValueAnimator extends com.emotibot.xychatlib.nineoldandroids.animation.Animator {
    ...
    private static final com.emotibot.xychatlib.nineoldandroids.animation.TypeEvaluator sIntEvaluator = new IntEvaluator();
     ...
     * @return A ValueAnimator object that is set up to animate between the given values.
     */
    public static ValueAnimator ofObject(com.emotibot.xychatlib.nineoldandroids.animation.TypeEvaluator evaluator, Object... values) {
        ValueAnimator anim = new ValueAnimator();
    ...
    public void setObjectValues(Object... values) {
        ...
        if (mValues == null || mValues.length == 0) {
            setValues(new PropertyValuesHolder[]{PropertyValuesHolder.ofObject("",
                    (com.emotibot.xychatlib.nineoldandroids.animation.TypeEvaluator)null, values)});
        } else {
            PropertyValuesHolder valuesHolder = mValues[0];
