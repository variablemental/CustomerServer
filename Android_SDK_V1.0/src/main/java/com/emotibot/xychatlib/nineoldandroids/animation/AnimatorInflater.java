...
import com.emotibot.xychatlib.nineoldandroids.animation.Animator;
import com.emotibot.xychatlib.nineoldandroids.animation.ArgbEvaluator;
import com.emotibot.xychatlib.nineoldandroids.animation.ObjectAnimator;
import com.emotibot.xychatlib.nineoldandroids.animation.ValueAnimator;
...
public class AnimatorInflater {
    ...
    /**
     * Loads an {@link com.emotibot.xychatlib.nineoldandroids.animation.Animator} object from a resource
     *
     ...
     */
    public static com.emotibot.xychatlib.nineoldandroids.animation.Animator loadAnimator(Context context, int id)
    ...
    private static com.emotibot.xychatlib.nineoldandroids.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser)
    ...
    private static com.emotibot.xychatlib.nineoldandroids.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser,
                                                                                AttributeSet attrs, com.emotibot.xychatlib.nineoldandroids.animation.AnimatorSet parent, int sequenceOrdering)
            throws XmlPullParserException, IOException {

        com.emotibot.xychatlib.nineoldandroids.animation.Animator anim = null;
        ArrayList<com.emotibot.xychatlib.nineoldandroids.animation.Animator> childAnims = null;
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                anim = new com.emotibot.xychatlib.nineoldandroids.animation.AnimatorSet();
                ...
                createAnimatorFromXml(c, parser, attrs, (com.emotibot.xychatlib.nineoldandroids.animation.AnimatorSet) anim,  ordering);
                a.recycle();
            } else {
            ...
            if (parent != null) {
                if (childAnims == null) {
                    childAnims = new ArrayList<com.emotibot.xychatlib.nineoldandroids.animation.Animator>();
                }
                childAnims.add(anim);
            }
        }
        if (parent != null && childAnims != null) {
            com.emotibot.xychatlib.nineoldandroids.animation.Animator[] animsArray = new com.emotibot.xychatlib.nineoldandroids.animation.Animator[childAnims.size()];
            int index = 0;
            for (com.emotibot.xychatlib.nineoldandroids.animation.Animator a : childAnims) {
                animsArray[index++] = a;
            }
    ...
    private static com.emotibot.xychatlib.nineoldandroids.animation.ObjectAnimator loadObjectAnimator(Context context, AttributeSet attrs)
            throws NotFoundException {

        com.emotibot.xychatlib.nineoldandroids.animation.ObjectAnimator anim = new ObjectAnimator();
     ...
     */
    private static com.emotibot.xychatlib.nineoldandroids.animation.ValueAnimator loadAnimator(Context context, AttributeSet attrs, com.emotibot.xychatlib.nineoldandroids.animation.ValueAnimator anim)
            throws NotFoundException {
        ...
        if (anim == null) {
            anim = new com.emotibot.xychatlib.nineoldandroids.animation.ValueAnimator();
        }
