...
public class MiniActivity extends AppCompatActivity {
     ...
     */
    private String appId = "10487333";

    private String appKey = "UE3XwnpZHGNFv3EgZPapqjmK";

    private String secretKey = "KlOC6XfCrTtiE6LWboYYiFS7PlkNoH6m";
    ...
    private void initThread(){
        hThread=new HandlerThread("miniActivity-thread");
        hThread.start();
